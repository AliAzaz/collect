...
class MbtilesFile implements Closeable, TileSource {
    ...
    String queryMetadata(SQLiteDatabase db, String key) throws MbtilesException {
     ...
     */
    private static @NonNull
    byte[] queryAnyTileHeader(SQLiteDatabase db) throws MbtilesException {
    ...
    public @NonNull
    String getMetadata(String key) throws MbtilesException {
